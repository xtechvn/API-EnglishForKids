...
namespace HuloToys_Service.Controllers.News.Business
{
    public partial class CourseBusiness
    {
        ...
        public async Task<List<GroupProductModel>> GetArticleCategoryByParentID(long parent_id)
        {
            ...
            {
                //LogHelper.InsertLogTelegramByUrl(configuration["telegram:log_try_catch:bot_token"], configuration["telegram:log_try_catch:group_id"], "GetArticleCategoryByParentID -GroupPr
                //oductRepository: " + ex);
            }
            return null;
        }
